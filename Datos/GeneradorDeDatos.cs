...
namespace PPAI_DSI_2024.Datos
{
    public class GeneradorDeDatos
    {
        ...
        public GeneradorDeDatos()
        {
            ...
            Bodega bodega2 = new Bodega("40.7128,-73.5000", "descripcion2", Convert.ToDateTime("20/09/2020"), "bodega1", "20/09/2019 - 20/09/2020", "historia1", region2);
            Bodega bodega3 = new Bodega("40.7128,-73.5000", "descripcion3", Convert.ToDateTime("20/09/2020"), "bodega1", "20/09/2019 - 20/09/2020", "historia1", region1);
            Bodega bodega4 = new Bodega("40.7128,-73.5000", "descripcion4", Convert.ToDateTime("20/09/2020"), "bodega1", "20/09/2019 - 20/09/2020", "historia1", region4);
            Bodega bodega5 = new Bodega("40.7128,-73.5000", "descripcion5", Convert.ToDateTime("20/09/2020"), "bodega1", "20/09/2019 - 20/09/2020", "historia1", region5);
            ...
            Vino vino1 = new Vino(2003, Convert.ToDateTime("14/04/2005"), "imagen1", "vino1", 7, 11000, varietal4, bodega5);
            Vino vino2 = new Vino(2010, Convert.ToDateTime("20/08/2011"), "imagen2", "vino2", 3, 5000, varietal2, bodega2);
            Vino vino3 = new Vino(2015, Convert.ToDateTime("14/04/2050"), "imagen3", "vino3", 10, 20000, varietal1, bodega4);
            Vino vino4 = new Vino(2006, Convert.ToDateTime("14/04/2005"), "imagen4", "vino4", 9, 18000, varietal4, bodega1);
            Vino vino5 = new Vino(2000, Convert.ToDateTime("14/04/2005"), "imagen5", "vino5", 2, 2000, varietal3, bodega5);
            Vino vino6 = new Vino(2002, Convert.ToDateTime("14/04/2005"), "imagen6", "vino6", 4, 5500, varietal1, bodega3);
            Vino vino7 = new Vino(2019, Convert.ToDateTime("14/04/2005"), "imagen7", "vino7", 5, 6000, varietal2, bodega5);

            vinos = new List<Vino>() { vino1, vino2, vino3, vino4, vino5, vino6, vino7 };
